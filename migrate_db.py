...
if __name__ == '__main__':
	...
	add_column('payment','amount_avax', 'float8')
	...
	rename_column('payment','tier1_expected_amount_ablock','min_amount_ablock')
	drop_column('payment','tier2_expected_amount_ablock')
	add_column('payment','min_amount_avax', 'float8')
	rename_column('payment','tier1_expected_amount_aablock','min_amount_aablock')
	drop_column('payment','tier2_expected_amount_aablock')
	rename_column('payment','tier1_expected_amount_wsys','min_amount_wsys')
